...
router.use('/types', requireSubscriptionFeature('hrms_leaves_v2_leavetype', { exact: false }), leaveTypeRoutes);
router.use('/policies', requireSubscriptionFeature('hrms_leaves_v2_leavepolicies', { exact: false }), leavePolicyRoutes);
router.use('/accrual', requireSubscriptionFeature('hrms_leaves_v2_leavepolicies', { exact: false }), accrualRoutes);
router.use('/requests', requireSubscriptionFeature(['hrms_leaves_v2_applyleave', 'my_hub_my_hub_general_apply_leave'], { exact: false }), leaveRequestRoutes);
router.use('/approvals', requireSubscriptionFeature('hrms_leaves_v2_approvals', { exact: false }), approvalsRoutes);
router.use('/adjustments', requireSubscriptionFeature('hrms_leaves_v2_leave_adjustment', { exact: false }), adjustmentRoutes);
router.use('/holidays', requireSubscriptionFeature(['hrms_leaves_v2_government_holidays', 'hrms_leaves_v2_add_government_holidays'], { exact: false }), holidayRoutes);
