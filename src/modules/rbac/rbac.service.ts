...
export const ADMIN_DEFAULT_PERMISSIONS: string[] = [
  ...
  'transaction.create', 'transaction.read', 'transaction.update', 'transaction.delete', 'transaction.manage',
  'client.create', 'client.read', 'client.update', 'client.delete', 'client.manage',
  'settings.read', 'settings.update', 'settings.manage',
  'role.create', 'role.read', 'role.update', 'role.delete', 'role.assign',
  'report.read', 'report.manage',
  'reimbursement.create', 'reimbursement.read', 'reimbursement.update', 'reimbursement.approve', 'reimbursement.manage',
