...
export const ADMIN_DEFAULT_PERMISSIONS: string[] = [
  ...
  'ticket.create', 'ticket.read', 'ticket.update', 'ticket.delete', 'ticket.assign', 'ticket.archive', 'ticket.manage',
  'attendance.create', 'attendance.read', 'attendance.update', 'attendance.manage', 'attendance.dashboard.read', 'attendance.clock.in_out',
  ...
  'leave.policy.read', 'leave.policy.update',
  ...
  'account.chart.read', 'account.chart.create', 'account.chart.update', 'account.chart.delete',
  'account.bank.read', 'account.bank.create', 'account.bank.update', 'account.bank.delete',
  'account.setting.read', 'account.setting.create', 'account.setting.update', 'account.setting.delete',
  'account.trash.read', 'account.trash.create', 'account.trash.update', 'account.trash.delete',
  'account.config.read', 'account.config.create', 'account.config.update', 'account.config.delete',
  ...
  'onboarding.create', 'onboarding.read', 'onboarding.update', 'onboarding.manage', 'onboarding.onboarded.read', 'onboarding.setting.read', 'onboarding.setting.update',
  ...
  'lead.create', 'lead.read', 'lead.update', 'lead.delete', 'lead.manage',
  ...
  'time_tracking.create', 'time_tracking.read', 'time_tracking.update', 'time_tracking.delete', 'time_tracking.manage',
];
...
export const USER_DEFAULT_PERMISSIONS: string[] = [
  ...
  'onboarding.read', 'onboarding.onboarded.read',
