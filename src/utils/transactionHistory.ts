...
export const Page = {
  ...
  API_HUB_DASHBOARD: "ApiHubDashboard",
  API_HUB_COLLECTION_DETAIL: "ApiHubCollectionDetail",
  API_HUB_ENDPOINT_DETAIL: "ApiHubEndpointDetail",
  API_HUB_ENVIRONMENT_SETTINGS: "ApiHubEnvironmentSettings",
  API_HUB_FLOW_EDITOR: "ApiHubFlowEditor",
