...
export const PERMISSIONS_BY_RESOURCE: Record<string, Permission[]> = {
  ...
  hotspot: [
    Permissions.HOTSPOT_OPENING_READ,
    Permissions.HOTSPOT_OPENING_CREATE,
    Permissions.HOTSPOT_CIRCULATION_READ,
    Permissions.HOTSPOT_CIRCULATION_CREATE,
    Permissions.HOTSPOT_CIRCULATION_UPDATE,
    Permissions.HOTSPOT_CIRCULATION_DELETE,
    Permissions.HOTSPOT_CIRCULATION_PIN,
    Permissions.HOTSPOT_BLOG_READ,
    Permissions.HOTSPOT_BLOG_CREATE,
    Permissions.HOTSPOT_BLOG_UPDATE,
    Permissions.HOTSPOT_BLOG_DELETE,
  ],
  ...
  qa: [
    Permissions.QA_SCOPE_CREATE,
    Permissions.QA_SCOPE_READ,
    Permissions.QA_SCOPE_UPDATE,
    Permissions.QA_SCOPE_DELETE,
    Permissions.QA_SCOPE_APPROVE,
    Permissions.QA_CASE_CREATE,
    Permissions.QA_CASE_READ,
    Permissions.QA_CASE_UPDATE,
    Permissions.QA_CASE_DELETE,
    Permissions.QA_SUITE_CREATE,
    Permissions.QA_SUITE_READ,
    Permissions.QA_SUITE_UPDATE,
    Permissions.QA_SUITE_DELETE,
    Permissions.QA_RUN_CREATE,
    Permissions.QA_RUN_READ,
    Permissions.QA_RUN_UPDATE,
    Permissions.QA_RUN_DELETE,
    Permissions.QA_SUBMISSION_CREATE,
    Permissions.QA_SUBMISSION_READ,
    Permissions.QA_SUBMISSION_UPDATE,
    Permissions.QA_SUBMISSION_DELETE,
    Permissions.QA_SUBMISSION_SUBMIT,
    Permissions.QA_SUBMISSION_SIGNOFF,
  ...
  yapiez: [
    ...
    Permissions.YAPIEZ_API_UPDATE,
    Permissions.YAPIEZ_API_DELETE,
    Permissions.YAPIEZ_API_TRY,
    Permissions.YAPIEZ_FLOW_CREATE,
    Permissions.YAPIEZ_FLOW_READ,
    Permissions.YAPIEZ_FLOW_UPDATE,
    Permissions.YAPIEZ_FLOW_DELETE,
    Permissions.YAPIEZ_FLOW_EXECUTE,
    Permissions.YAPIEZ_RUN_READ,
    Permissions.YAPIEZ_RUN_DELETE,
    Permissions.YAPIEZ_ENV_READ,
    Permissions.YAPIEZ_ENV_MANAGE,
