...
//     res.json({ success: true, data: company } as ApiResponse);
//   }
...
//     if (existing) throw new ValidationError("Company name already exists");
...
//     // First, set all companies of tenant to inactive
