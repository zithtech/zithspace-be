...
const PERMISSION_DESCRIPTIONS: Record<string, string> = {
  ...
  'payroll.settings.read': 'General Settings · view',
  'payroll.settings.update': 'General Settings · edit',
  'payroll.components.read': 'Salary Components · view',
  'payroll.components.create': 'Salary Components · create',
  'payroll.components.update': 'Salary Components · edit',
  'payroll.components.delete': 'Salary Components · delete',
  'payroll.structures.read': 'Salary Structures · view',
  'payroll.structures.create': 'Salary Structures · create',
  'payroll.structures.update': 'Salary Structures · edit',
  'payroll.structures.delete': 'Salary Structures · delete',
  'payroll.schedules.read': 'Pay Schedules & Groups · view',
  'payroll.schedules.create': 'Pay Schedules & Groups · create',
  'payroll.schedules.update': 'Pay Schedules & Groups · edit',
  'payroll.schedules.delete': 'Pay Schedules & Groups · delete',
  'payroll.statutory.read': 'Statutory (PF & ESI) · view',
  'payroll.statutory.update': 'Statutory (PF & ESI) · edit',
  'payroll.state_statutory.read': 'Professional Tax & LWF · view',
  'payroll.state_statutory.create': 'Professional Tax & LWF · create',
  'payroll.state_statutory.update': 'Professional Tax & LWF · edit',
  'payroll.state_statutory.delete': 'Professional Tax & LWF · delete',
  'payroll.workflows.read': 'Approval Workflows · view',
  'payroll.workflows.create': 'Approval Workflows · create',
  'payroll.workflows.update': 'Approval Workflows · edit',
  'payroll.workflows.delete': 'Approval Workflows · delete',
  'payroll.payslip_bank.read': 'Payslip & Bank · view',
  'payroll.payslip_bank.update': 'Payslip & Bank · edit (template, logo, bank)',
  'payroll.employees.read': 'Employee Pay Setup · view',
  'payroll.employees.create': 'Employee Pay Setup · assign salary',
  'payroll.employees.update': 'Employee Pay Setup · revise / edit profile',
  'payroll.employees.delete': 'Employee Pay Setup · revoke assignment',
  'payroll.run.read': 'Run Payroll · view runs',
  'payroll.run.create': 'Run Payroll · create a run',
  'payroll.run.process': 'Run Payroll · compute / LOP / submit',
  'payroll.run.approve': 'Run Payroll · approve / reject',
  'payroll.run.finalize': 'Run Payroll · finalize & lock',
  'payroll.run.pay': 'Run Payroll · mark paid & bank file',
  'payroll.run.payslips': 'Run Payroll · generate payslips',
  'payroll.run.delete': 'Run Payroll · delete draft',
  'payroll.reports.read': 'Reports · view salary register',
  'payroll.reports.export': 'Reports · export CSV',
  'payroll.my_payslips.read': 'My Payslips · view own payslips',
  ...
  'qa.playbook.create': 'Create workspace playbooks',
  'qa.playbook.read': 'View playbooks catalog and details',
  'qa.playbook.update': 'Edit and manage playbooks',
  'qa.playbook.delete': 'Delete playbooks and manage categories',
  'qa.playbook.template': 'Download playbook templates and copy AI prompts',
  'qa.playbook.upload': 'Import playbooks from templates or documents',
  'qa.playbook.request': 'Submit requests for new playbooks',
  'qa.playbook.requested': 'View requested playbooks and track progress',
  'qa.playbook.access': 'Manage and decide premium playbook access requests',
  ...
  'yapiez.api.delete': 'Delete Yapiez API definitions',
  'yapiez.api.try': 'Send a one-off request from the Yapiez API editor to capture a real response',
  'yapiez.flow.create': 'Create Yapiez API flows',
  'yapiez.flow.read': 'View Yapiez API flows and their steps',
  'yapiez.flow.update': 'Edit Yapiez flows, steps, assertions and extractions',
  'yapiez.flow.delete': 'Delete Yapiez API flows',
  'yapiez.flow.execute': 'Run Yapiez API flows against an environment',
  'yapiez.run.read': 'View Yapiez flow run results',
  'yapiez.run.delete': 'Delete Yapiez flow run history',
  'yapiez.environment.read': 'View Yapiez environments',
  'yapiez.environment.manage': 'Create and edit Yapiez environments and their credentials',
  'yapiez.manage': 'Full Yapiez management and configuration',
