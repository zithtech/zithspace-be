 ...
 * @access  Private
 */
router.get('/', InvoiceSettingsController.getProfiles);
 ...
 * @access  Private
 */
router.get('/:id', InvoiceSettingsController.getProfileById);
 ...
 * @access  Private (Admin only)
 */
router.patch('/:id', InvoiceSettingsController.updateProfile);
 ...
 * @access  Private (Admin only)
 */
router.delete('/:id', InvoiceSettingsController.hardDeleteProfile);
