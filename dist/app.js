...
const salaryComponentRoutes_1 = __importDefault(
  require("@/routes/salaryComponentRoutes"),
);
...
const invoiceSettingsRoutes_1 = __importDefault(
  require("@/routes/invoiceSettingsRoutes"),
);
...
const sprintCompletion_1 = __importDefault(
  require("@/routes/sprintCompletion"),
);
...
const companyGovernmentHoliday_routes_1 = __importDefault(
  require("./routes/companyGovernmentHoliday.routes"),
);
const leaveAdjustmentRoutes_1 = __importDefault(
  require("./routes/leaveAdjustmentRoutes"),
);
const reimbursementCategory_1 = __importDefault(
  require("@/routes/reimbursementCategory"),
);
const employmentTypeRoutes_1 = __importDefault(
  require("@/routes/employmentTypeRoutes"),
);
const repositoryRoutes_1 = __importDefault(
  require("@/routes/repositoryRoutes"),
);
const departmentRoutes_1 = __importDefault(
  require("@/routes/departmentRoutes"),
);
const subDepartmentRoutes_1 = __importDefault(
  require("@/routes/subDepartmentRoutes"),
);
const positionRoutes_1 = __importDefault(require("@/routes/positionRoutes"));
const leaveOriginRoutes_1 = __importDefault(
  require("@/routes/leaveOriginRoutes"),
);
const emailHistoryRoutes_1 = __importDefault(
  require("@/routes/emailHistoryRoutes"),
);
// Load environment
...
app.use(
  "/api/company-government-holidays",
  companyGovernmentHoliday_routes_1.default,
);
