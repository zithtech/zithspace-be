...
router.use((0, entitlements_middleware_1.requireSubscriptionFeature)('finance_invoice'));
// ==================== INVOICE ROUTES ====================
...
router.get('/deleted', (0, permission_1.requirePermission)(permissions_1.Permissions.INVOICE_TRASH_READ), (0, entitlements_middleware_1.requireSubscriptionFeature)('finance_invoice_invoice_trash', { exact: false }), (req, res) => InvoiceController_1.InvoiceController.getDeletedInvoices(req, res));
...
// Create new invoice
router.post('/', (0, permission_1.requirePermission)(permissions_1.Permissions.INVOICE_CREATE), (0, entitlements_middleware_1.requireSubscriptionFeature)('finance_invoice_newinvoice', { exact: false }), (req, res) => InvoiceController_1.InvoiceController.createInvoice(req, res));
...
router.delete('/:id', (0, permission_1.requirePermission)(permissions_1.Permissions.INVOICE_DELETE), (0, entitlements_middleware_1.requireSubscriptionFeature)('finance_invoice_invoice_trash', { exact: false }), (req, res) => InvoiceController_1.InvoiceController.deleteInvoice(req, res));
...
router.post('/bulk-permanent-delete', (0, permission_1.requirePermission)(permissions_1.Permissions.INVOICE_TRASH_DELETE), (0, entitlements_middleware_1.requireSubscriptionFeature)('finance_invoice_invoice_trash', { exact: false }), (req, res) => InvoiceController_1.InvoiceController.bulkPermanentDeleteInvoices(req, res));
// Update invoice
router.put('/:id', (0, permission_1.requirePermission)(permissions_1.Permissions.INVOICE_UPDATE), (0, entitlements_middleware_1.requireSubscriptionFeature)('finance_invoice_newinvoice', { exact: false }), (req, res) => InvoiceController_1.InvoiceController.updateInvoice(req, res));
