...
router.post("/", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_POSITION_CREATE), (0, entitlements_middleware_1.requireSubscriptionFeature)("admin_org_structure_position", { exact: false }), positionController_1.PositionController.createPosition);
...
router.put("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_POSITION_UPDATE), (0, entitlements_middleware_1.requireSubscriptionFeature)("admin_org_structure_position", { exact: false }), positionController_1.PositionController.updatePosition);
router.delete("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_POSITION_DELETE), (0, entitlements_middleware_1.requireSubscriptionFeature)("admin_org_structure_position", { exact: false }), positionController_1.PositionController.deletePosition);
