...
router.get("/", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_POSITION_READ), positionController_1.PositionController.getPositions);
router.get("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_POSITION_READ), positionController_1.PositionController.getPositionById);
