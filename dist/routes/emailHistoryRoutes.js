...
router.get('/', (0, permission_1.requirePermission)(permissions_1.Permissions.SETTINGS_READ), emailHistoryController_1.EmailHistoryController.getEmailLogs);
router.get('/modules', (0, permission_1.requirePermission)(permissions_1.Permissions.SETTINGS_READ), emailHistoryController_1.EmailHistoryController.getModules);
