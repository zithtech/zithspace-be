...
// Create a new grade
router.post("/", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_GRADE_CREATE), (0, entitlements_middleware_1.requireSubscriptionFeature)("admin_org_structure_grades", { exact: false }), gradeController_1.GradeController.createGrade);
...
router.put("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_GRADE_UPDATE), (0, entitlements_middleware_1.requireSubscriptionFeature)("admin_org_structure_grades", { exact: false }), gradeController_1.GradeController.updateGrade);
router.delete("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ORG_GRADE_DELETE), (0, entitlements_middleware_1.requireSubscriptionFeature)("admin_org_structure_grades", { exact: false }), gradeController_1.GradeController.deleteGrade);
