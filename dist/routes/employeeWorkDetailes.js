...
// CREATE work detail
router.post("/", (0, permission_1.requirePermission)(permissions_1.Permissions.ONBOARDING_MANAGE), employeeWorkDetailesController_1.EmployeeWorkDetailController.createWorkDetail);
...
// UPDATE work detail
router.put("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ONBOARDING_MANAGE), employeeWorkDetailesController_1.EmployeeWorkDetailController.updateWorkDetail);
// DELETE work detail
router.delete("/:id", (0, permission_1.requirePermission)(permissions_1.Permissions.ONBOARDING_MANAGE), employeeWorkDetailesController_1.EmployeeWorkDetailController.deleteWorkDetail);
