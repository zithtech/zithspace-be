...
router.post("/", employmentTypeController_1.EmploymentTypeController.createEmploymentType);
router.get("/", employmentTypeController_1.EmploymentTypeController.getAllEmploymentTypes);
router.get("/:id", employmentTypeController_1.EmploymentTypeController.getEmploymentTypeById);
