...
CREATE TABLE "exit_notice_policies" (
    ...
    "probation_notice_period_days" INTEGER NOT NULL,
    "notice_buyout_allowed" BOOLEAN NOT NULL DEFAULT false,
    "buyout_calculation_type" TEXT,
    "status" TEXT NOT NULL DEFAULT 'active',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "exit_notice_policies_tenant_id_policy_name_key" ON "exit_notice_policies"("tenant_id" ASC, "policy_name" ASC);
...
-- AddForeignKey
ALTER TABLE "user_preferences" ADD CONSTRAINT "fk_user_preferences_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "vendor-basic-information" ADD CONSTRAINT "fk_vendor_created_by" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "vendor-basic-information" ADD CONSTRAINT "fk_vendor_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "vendor-basic-information" ADD CONSTRAINT "fk_vendor_updated_by" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "vendor_business_detailes" ADD CONSTRAINT "fk_vendor_business" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "vendor_contact_person" ADD CONSTRAINT "fk_vendor_contact" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "vendor_document" ADD CONSTRAINT "fk_vendor" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "vendor_relations" ADD CONSTRAINT "fk_vendor_relations_vendor" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
