...
-- CreateIndex
CREATE UNIQUE INDEX "sub_departments_tenant_id_code_key" ON "sub_departments"("tenant_id", "code");
...
-- CreateIndex
CREATE INDEX "idx_tickets_bucket_id" ON "tickets"("bucket_id");

-- CreateIndex
CREATE INDEX "idx_tickets_is_deleted_deleted_at" ON "tickets"("is_deleted", "deleted_at");

-- CreateIndex
CREATE INDEX "idx_tickets_project_archived" ON "tickets"("project_id", "is_archived");

-- CreateIndex
CREATE INDEX "idx_tickets_project_is_deleted" ON "tickets"("project_id", "is_deleted");
...
-- CreateIndex
CREATE INDEX "idx_tickets_tenant_is_deleted" ON "tickets"("tenant_id", "is_deleted");
...
-- CreateIndex
CREATE INDEX "idx_attachment_tenant_ticket" ON "ticket_attachments"("tenant_id", "ticket_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "attendance_unique_user_date" ON "attendance"("tenant_id", "user_id", "date");
...
-- CreateIndex
CREATE INDEX "idx_buckets_created_by_id" ON "buckets"("created_by_id");

-- CreateIndex
CREATE INDEX "idx_buckets_project_id" ON "buckets"("project_id");

-- CreateIndex
CREATE INDEX "idx_buckets_tenant_id" ON "buckets"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_bucket_per_project" ON "buckets"("tenant_id", "project_id", "name");

-- CreateIndex
CREATE INDEX "idx_bucket_members_bucket_id" ON "bucket_members"("bucket_id");

-- CreateIndex
CREATE INDEX "idx_bucket_members_user_id" ON "bucket_members"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_bucket_member" ON "bucket_members"("bucket_id", "user_id");

-- CreateIndex
CREATE INDEX "idx_sprint_completion_logs_performed_at" ON "sprint_completion_logs"("performed_at");

-- CreateIndex
CREATE INDEX "idx_sprint_completion_logs_project_id" ON "sprint_completion_logs"("project_id");

-- CreateIndex
CREATE INDEX "idx_sprint_completion_logs_sprint_plan_id" ON "sprint_completion_logs"("sprint_plan_id");

-- CreateIndex
CREATE INDEX "idx_sprint_completion_logs_tenant_id" ON "sprint_completion_logs"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_sprint_completion_logs_ticket_id" ON "sprint_completion_logs"("ticket_id");

-- CreateIndex
CREATE INDEX "idx_general_settings_tenant_id" ON "general_settings"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_invoice_settings_tenant_id" ON "invoice_settings"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_payment_settings_tenant_id" ON "payment_settings"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_settings_profiles_general_id" ON "settings_profiles"("general_id");

-- CreateIndex
CREATE INDEX "idx_settings_profiles_invoice_id" ON "settings_profiles"("invoice_id");

-- CreateIndex
CREATE INDEX "idx_settings_profiles_payment_id" ON "settings_profiles"("payment_id");

-- CreateIndex
CREATE INDEX "idx_settings_profiles_tenant_id" ON "settings_profiles"("tenant_id");
...
-- CreateIndex
CREATE INDEX "idx_invoices_first_payment_date" ON "invoices"("first_payment_date");

-- CreateIndex
CREATE INDEX "idx_invoices_last_payment_date" ON "invoices"("last_payment_date");
...
-- CreateIndex
CREATE INDEX "idx_invoice_items_tenant_id" ON "invoice_line_items"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_invoice_line_items_invoice_id" ON "invoice_line_items"("invoice_id");

-- CreateIndex
CREATE INDEX "idx_invoice_line_items_invoice_row" ON "invoice_line_items"("invoice_id", "row_number");
...
-- CreateIndex
CREATE INDEX "idx_invoice_taxes_tenant_id" ON "invoice_taxes"("tenant_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_salary_component_tenant_code" ON "salary_components"("tenant_id", "component_code");

-- CreateIndex
CREATE UNIQUE INDEX "uq_companies_tenant_name" ON "companies"("tenant_id", "name");

-- CreateIndex
CREATE INDEX "company_government_holidays_tenant_id_idx" ON "company_government_holidays"("tenant_id");

-- CreateIndex
CREATE INDEX "company_government_holidays_created_by_id_idx" ON "company_government_holidays"("created_by_id");

-- CreateIndex
CREATE INDEX "company_government_holidays_tenant_id_from_date_idx" ON "company_government_holidays"("tenant_id", "from_date");

-- CreateIndex
CREATE INDEX "idx_documenthub_created_by_id" ON "document_hub"("createdById");

-- CreateIndex
CREATE INDEX "idx_documenthub_project_id" ON "document_hub"("projectId");

-- CreateIndex
CREATE INDEX "idx_documenthub_tenant_id" ON "document_hub"("tenantId");

-- CreateIndex
CREATE INDEX "idx_documenthub_ticket_id" ON "document_hub"("ticketId");

-- CreateIndex
CREATE UNIQUE INDEX "documents_share_token_key" ON "documents"("share_token");

-- CreateIndex
CREATE UNIQUE INDEX "documenttree_documentid_key" ON "documenttree"("documentId");

-- CreateIndex
CREATE INDEX "document_history_createdbyid_idx" ON "document_history"("createdById");
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_timesheet_user_week" ON "timesheets"("user_id", "week_start");

-- CreateIndex
CREATE INDEX "idx_timesheet_rows_created_by" ON "timesheet_rows"("created_by_id");

-- CreateIndex
CREATE INDEX "idx_timesheet_rows_timesheet_id" ON "timesheet_rows"("timesheet_id");

-- CreateIndex
CREATE INDEX "idx_timesheet_rows_updated_by" ON "timesheet_rows"("updated_by_id");

-- CreateIndex
CREATE UNIQUE INDEX "leave_origin_structures_tenant_id_origin_sub_origin_key" ON "leave_origin_structures"("tenant_id", "origin", "sub_origin_id");

-- CreateIndex
CREATE UNIQUE INDEX "repositories_tenant_id_name_key" ON "repositories"("tenant_id", "name");

-- CreateIndex
CREATE INDEX "ticket_branches_ticket_id_idx" ON "ticket_branches"("ticket_id");

-- CreateIndex
CREATE INDEX "ticket_branches_repository_id_idx" ON "ticket_branches"("repository_id");

-- CreateIndex
CREATE INDEX "ticket_pull_requests_ticket_id_idx" ON "ticket_pull_requests"("ticket_id");

-- CreateIndex
CREATE INDEX "ticket_pull_requests_repository_id_idx" ON "ticket_pull_requests"("repository_id");

-- CreateIndex
CREATE INDEX "email_logs_module_module_id_idx" ON "email_logs"("module", "module_id");

-- CreateIndex
CREATE INDEX "email_logs_module_sent_at_idx" ON "email_logs"("module", "sent_at");
...
-- CreateIndex
CREATE INDEX "email_logs_tenant_sent_at_idx" ON "email_logs"("tenant_id", "sent_at");

-- CreateIndex
CREATE UNIQUE INDEX "employee_identities_employee_id_key" ON "employee_identities"("employee_id");

-- CreateIndex
CREATE UNIQUE INDEX "employee_timelines_employee_id_key" ON "employee_timelines"("employee_id");

-- CreateIndex
CREATE UNIQUE INDEX "employee_additional_details_employee_id_key" ON "employee_additional_details"("employee_id");

-- CreateIndex
CREATE UNIQUE INDEX "employee_bank_details_employee_id_key" ON "employee_bank_details"("employee_id");

-- CreateIndex
CREATE UNIQUE INDEX "employee_payroll_details_employee_id_key" ON "employee_payroll_details"("employee_id");

-- CreateIndex
CREATE UNIQUE INDEX "company_settings_tenant_id_key" ON "employee_settings"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "calendar_integrations_mail_account_id_unique" ON "calendar_integrations"("mail_account_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "calendar_integrations_unique_user_provider" ON "calendar_integrations"("user_id", "provider");
...
-- CreateIndex
CREATE UNIQUE INDEX "calendar_events_unique_provider_external_tenant" ON "calendar_events"("provider", "external_id", "tenant_id");

-- CreateIndex
CREATE INDEX "idx_exception_event_id" ON "calendar_event_exceptions"("event_id");

-- CreateIndex
CREATE INDEX "idx_exception_tenant_id" ON "calendar_event_exceptions"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_exception_user_id" ON "calendar_event_exceptions"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_event_occurrence" ON "calendar_event_exceptions"("event_id", "original_date");
...
-- CreateIndex
CREATE INDEX "auth_logs_created_at_idx" ON "authorization_logs"("created_at");

-- CreateIndex
CREATE INDEX "auth_logs_tenant_user_idx" ON "authorization_logs"("tenant_id", "user_id");

-- CreateIndex
CREATE UNIQUE INDEX "clients_v2_client_code_key" ON "clients_v2"("client_code");

-- CreateIndex
CREATE UNIQUE INDEX "clients_v2_tenant_id_client_code_key" ON "clients_v2"("tenant_id", "client_code");

-- CreateIndex
CREATE INDEX "leave_ledger_employee_id_idx" ON "leave_ledger"("employee_id");

-- CreateIndex
CREATE INDEX "leave_ledger_leave_type_id_idx" ON "leave_ledger"("leave_type_id");

-- CreateIndex
CREATE INDEX "leave_ledger_reference_id_idx" ON "leave_ledger"("reference_id");

-- CreateIndex
CREATE INDEX "leave_ledger_tenant_id_idx" ON "leave_ledger"("tenant_id");

-- CreateIndex
CREATE INDEX "leave_ledger_transaction_date_idx" ON "leave_ledger"("transaction_date");

-- CreateIndex
CREATE INDEX "job_requisitions_tenant_id_status_idx" ON "job_requisitions"("tenant_id", "status");

-- CreateIndex
CREATE INDEX "job_requisitions_client_id_idx" ON "job_requisitions"("client_id");

-- CreateIndex
CREATE UNIQUE INDEX "job_requisitions_tenant_id_ticket_id_key" ON "job_requisitions"("tenant_id", "ticket_id");

-- CreateIndex
CREATE UNIQUE INDEX "reimbursement_settings_categories_tenant_id_code_key" ON "reimbursement_settings_categories"("tenant_id", "code");

-- CreateIndex
CREATE INDEX "idx_reimbursement_policies_origin" ON "reimbursement_policies"("origin_type", "origin_id");

-- CreateIndex
CREATE INDEX "idx_policy_rules_policy_id" ON "reimbursement_policy_rules"("policy_id");

-- CreateIndex
CREATE INDEX "idx_policy_approvers_rule_id" ON "reimbursement_policy_approvers"("policy_rule_id");

-- CreateIndex
CREATE INDEX "time_tracking_entries_project_id_idx" ON "time_tracking_entries"("project_id");

-- CreateIndex
CREATE INDEX "time_tracking_entries_tenant_id_user_id_idx" ON "time_tracking_entries"("tenant_id", "user_id");

-- CreateIndex
CREATE INDEX "time_tracking_logs_tenant_id_idx" ON "time_tracking_logs"("tenant_id");

-- CreateIndex
CREATE INDEX "time_tracking_logs_time_tracking_id_idx" ON "time_tracking_logs"("time_tracking_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "exit_notice_policies_code_key" ON "exit_notice_policies"("code");

-- CreateIndex
CREATE UNIQUE INDEX "recruitment_statuses_tenant_id_status_name_key" ON "recruitment_statuses"("tenant_id", "status_name");

-- CreateIndex
CREATE UNIQUE INDEX "recruitment_actions_tenant_id_action_name_key" ON "recruitment_actions"("tenant_id", "action_name");
...
-- CreateIndex
CREATE INDEX "candidate_work_experiences_candidate_id_idx" ON "candidate_work_experiences"("candidate_id");

-- CreateIndex
CREATE INDEX "candidate_skill_matrices_candidate_id_idx" ON "candidate_skill_matrices"("candidate_id");

-- CreateIndex
CREATE INDEX "candidate_educations_candidate_id_idx" ON "candidate_educations"("candidate_id");

-- CreateIndex
CREATE INDEX "candidate_interview_slots_candidate_id_idx" ON "candidate_interview_slots"("candidate_id");

-- CreateIndex
CREATE UNIQUE INDEX "candidate_details_email_key" ON "candidate_details"("email");

-- CreateIndex
CREATE INDEX "_AssignedRecruiters_B_index" ON "_AssignedRecruiters"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_AssignedRecruiters_AB_unique" ON "_AssignedRecruiters"("A", "B");

-- CreateIndex
CREATE INDEX "_RequisitionRecruiters_B_index" ON "_RequisitionRecruiters"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_RequisitionRecruiters_AB_unique" ON "_RequisitionRecruiters"("A", "B");

-- CreateIndex
CREATE INDEX "idx_attendance_sessions_attendance_id" ON "attendance_sessions"("attendance_id");

-- CreateIndex
CREATE UNIQUE INDEX "uq_employee_field_tenant_company_system_key" ON "employee_field_configs"("tenant_id", "company_id", "system_key");

-- CreateIndex
CREATE INDEX "environments_tenant_idx" ON "environments"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "environments_tenant_code_unique" ON "environments"("tenant_id", "code");

-- CreateIndex
CREATE UNIQUE INDEX "feature_tiers_code_key" ON "feature_tiers"("code");

-- CreateIndex
CREATE UNIQUE INDEX "features_code_key" ON "features"("code");

-- CreateIndex
CREATE INDEX "leave_carry_forwards_leave_type_id_idx" ON "leave_carry_forwards"("leave_type_id");

-- CreateIndex
CREATE INDEX "leave_carry_forwards_sub_origin_id_idx" ON "leave_carry_forwards"("sub_origin_id");

-- CreateIndex
CREATE INDEX "leave_carry_forwards_tenant_id_idx" ON "leave_carry_forwards"("tenant_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "mail_accounts_provider_email_tenant_unique" ON "mail_accounts"("provider", "email", "tenant_id");
...
-- CreateIndex
CREATE INDEX "idx_mail_messages_account_id" ON "mail_messages"("account_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "mail_messages_external_id_account_unique" ON "mail_messages"("external_id", "account_id");

-- CreateIndex
CREATE INDEX "mail_settings_active_idx" ON "mail_settings"("tenant_id", "is_active");

-- CreateIndex
CREATE INDEX "mail_settings_tenant_idx" ON "mail_settings"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "mail_settings_unique_name_per_tenant" ON "mail_settings"("tenant_id", "name");

-- CreateIndex
CREATE INDEX "idx_mail_sync_logs_account_id" ON "mail_sync_logs"("account_id");

-- CreateIndex
CREATE INDEX "idx_mail_sync_logs_tenant_id" ON "mail_sync_logs"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_mail_threads_account_id" ON "mail_threads"("account_id");

-- CreateIndex
CREATE INDEX "idx_mail_threads_external_thread_id" ON "mail_threads"("external_thread_id");

-- CreateIndex
CREATE INDEX "idx_mail_threads_tenant_id" ON "mail_threads"("tenant_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_payslip_field_tenant_label" ON "payslip_fields"("tenant_id", "label");

-- CreateIndex
CREATE INDEX "idx_payslips_tenant_employee" ON "payslips"("tenant_id", "employee_id");

-- CreateIndex
CREATE INDEX "idx_payslips_tenant_period" ON "payslips"("tenant_id", "from_date", "to_date");

-- CreateIndex
CREATE UNIQUE INDEX "pipeline_stages_tenant_id_name_key" ON "pipeline_stages"("tenant_id", "name");

-- CreateIndex
CREATE UNIQUE INDEX "unique_mapping" ON "plan_mappings"("plan_id", "module_id", "sub_module_id", "feature_id", "feature_tier_id");

-- CreateIndex
CREATE UNIQUE INDEX "plans_code_key" ON "plans"("code");

-- CreateIndex
CREATE INDEX "idx_ra_item" ON "reimbursement_attachments"("reimbursement_item_id");

-- CreateIndex
CREATE INDEX "idx_ra_request" ON "reimbursement_attachments"("reimbursement_request_id");

-- CreateIndex
CREATE UNIQUE INDEX "reimbursement_categories_tenant_id_name_key" ON "reimbursement_categories"("tenant_id", "name");

-- CreateIndex
CREATE INDEX "idx_item_date" ON "reimbursement_item"("date");

-- CreateIndex
CREATE INDEX "idx_item_request" ON "reimbursement_item"("reimbursement_request_id");

-- CreateIndex
CREATE INDEX "idx_item_tenant" ON "reimbursement_item"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_reimbursement_requests_category" ON "reimbursement_requests"("reimbursement_category_id");

-- CreateIndex
CREATE INDEX "idx_reimbursement_requests_status" ON "reimbursement_requests"("status");

-- CreateIndex
CREATE INDEX "idx_reimbursement_requests_tenant_year" ON "reimbursement_requests"("tenant_id", "year", "created_at");

-- CreateIndex
CREATE INDEX "idx_reimbursement_requests_user" ON "reimbursement_requests"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "reimbursement_requests_tenant_id_request_id_key" ON "reimbursement_requests"("tenant_id", "request_id");

-- CreateIndex
CREATE UNIQUE INDEX "reimbursement_requests_tenant_id_year_request_id_key" ON "reimbursement_requests"("tenant_id", "year", "request_id");

-- CreateIndex
CREATE INDEX "idx_salary_structure_tenant" ON "salary_structures"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_structure_component_component" ON "salary_structure_components"("component_id");

-- CreateIndex
CREATE INDEX "idx_structure_component_structure" ON "salary_structure_components"("structure_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_employee_month_year" ON "salary_payouts"("employee_id", "month", "year");

-- CreateIndex
CREATE INDEX "idx_workflow_active" ON "salary_approval_workflows"("is_active");

-- CreateIndex
CREATE INDEX "idx_workflow_tenant" ON "salary_approval_workflows"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_steps_fallback_user" ON "salary_approval_steps"("fallback_user_id");

-- CreateIndex
CREATE INDEX "idx_steps_order" ON "salary_approval_steps"("step_order");

-- CreateIndex
CREATE INDEX "idx_steps_workflow" ON "salary_approval_steps"("workflow_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_workflow_step" ON "salary_approval_steps"("workflow_id", "step_order");

-- CreateIndex
CREATE INDEX "idx_logs_payout" ON "salary_approval_logs"("salary_payout_id");

-- CreateIndex
CREATE INDEX "idx_logs_tenant" ON "salary_approval_logs"("tenant_id");

-- CreateIndex
CREATE INDEX "idx_logs_user" ON "salary_approval_logs"("performed_by_id");

-- CreateIndex
CREATE UNIQUE INDEX "sub_modules_code_key" ON "sub_modules"("code");

-- CreateIndex
CREATE INDEX "idx_tenant_mappings_tenant_id" ON "tenant_mappings"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "unique_tenant_mapping" ON "tenant_mappings"("tenant_id", "module_id", "sub_module_id", "feature_id", "feature_tier_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "zithspace_admin_users_email_key" ON "zithspace_admin_users"("email");

-- CreateIndex
CREATE INDEX "idx_users_email" ON "zithspace_admin_users"("email");

-- CreateIndex
CREATE INDEX "idx_zoho_events_calendar_id" ON "zoho_events"("calendar_id");

-- CreateIndex
CREATE INDEX "idx_zoho_events_start_time" ON "zoho_events"("start_time");

-- CreateIndex
CREATE INDEX "idx_zoho_events_user_id" ON "zoho_events"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "zoho_events_event_user_unique" ON "zoho_events"("event_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "documents" ADD CONSTRAINT "documents_documentHubId_fkey" FOREIGN KEY ("documentHubId") REFERENCES "document_hub"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "documenttree" ADD CONSTRAINT "documenttree_documentHubId_fkey" FOREIGN KEY ("documentHubId") REFERENCES "document_hub"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "documenttree" ADD CONSTRAINT "documenttree_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "documenttree" ADD CONSTRAINT "documenttree_deleted_by_id_fkey" FOREIGN KEY ("deleted_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "timesheet_rows" ADD CONSTRAINT "timesheet_rows_timesheet_id_fkey" FOREIGN KEY ("timesheet_id") REFERENCES "timesheets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "origin_leave_types" ADD CONSTRAINT "origin_leave_types_leave_type_id_fkey" FOREIGN KEY ("leave_type_id") REFERENCES "leave_types"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "employee_work_details" ADD CONSTRAINT "employee_work_details_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "employee_timelines" ADD CONSTRAINT "employee_timelines_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "employee_project_mappings" ADD CONSTRAINT "employee_project_mappings_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "employee_additional_details" ADD CONSTRAINT "employee_additional_details_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "employee_payroll_details" ADD CONSTRAINT "employee_payroll_details_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "leave_ledger" ADD CONSTRAINT "leave_ledger_leave_type_id_fkey" FOREIGN KEY ("leave_type_id") REFERENCES "leave_types"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "invoice_template_fields" ADD CONSTRAINT "invoice_template_fields_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "invoice_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "job_requisitions" ADD CONSTRAINT "job_requisitions_recruitment_client_id_fkey" FOREIGN KEY ("recruitment_client_id") REFERENCES "recruitment_client_basic_information"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "job_requisitions" ADD CONSTRAINT "job_requisitions_account_manager_id_fkey" FOREIGN KEY ("account_manager_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "job_requisitions" ADD CONSTRAINT "job_requisitions_delivery_manager_id_fkey" FOREIGN KEY ("delivery_manager_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "job_requisition_contacts" ADD CONSTRAINT "job_requisition_contacts_job_requisition_id_fkey" FOREIGN KEY ("job_requisition_id") REFERENCES "job_requisitions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vendor_contact_person" ADD CONSTRAINT "vendor_contact_person_vendor_id_fkey" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vendor_business_detailes" ADD CONSTRAINT "vendor_business_detailes_vendor_id_fkey" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vendor_relations" ADD CONSTRAINT "vendor_relations_vendor_id_fkey" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vendor_document" ADD CONSTRAINT "vendor_document_vendor_id_fkey" FOREIGN KEY ("vendor_id") REFERENCES "vendor-basic-information"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_reimbursement_item_id_fkey" FOREIGN KEY ("reimbursement_item_id") REFERENCES "reimbursement_items"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "reimbursement_policy_rules" ADD CONSTRAINT "reimbursement_policy_rules_policy_id_fkey" FOREIGN KEY ("policy_id") REFERENCES "reimbursement_policies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reimbursement_policy_approvers" ADD CONSTRAINT "reimbursement_policy_approvers_policy_rule_id_fkey" FOREIGN KEY ("policy_rule_id") REFERENCES "reimbursement_policy_rules"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exit_types" ADD CONSTRAINT "exit_types_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exit_types" ADD CONSTRAINT "exit_types_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reasons_for_exit" ADD CONSTRAINT "reasons_for_exit_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "reasons_for_exit" ADD CONSTRAINT "reasons_for_exit_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "recruitment_statuses" ADD CONSTRAINT "recruitment_statuses_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "recruitment_statuses" ADD CONSTRAINT "recruitment_statuses_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "recruitment_actions" ADD CONSTRAINT "recruitment_actions_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "recruitment_actions" ADD CONSTRAINT "recruitment_actions_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "candidate_skill_matrices" ADD CONSTRAINT "candidate_skill_matrices_candidate_id_fkey" FOREIGN KEY ("candidate_id") REFERENCES "candidates"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "candidate_interview_slots" ADD CONSTRAINT "candidate_interview_slots_candidate_id_fkey" FOREIGN KEY ("candidate_id") REFERENCES "candidates"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "salary_payouts" ADD CONSTRAINT "salary_payouts_workflow_id_fkey" FOREIGN KEY ("workflow_id") REFERENCES "salary_approval_workflows"("id") ON DELETE SET NULL ON UPDATE CASCADE;
